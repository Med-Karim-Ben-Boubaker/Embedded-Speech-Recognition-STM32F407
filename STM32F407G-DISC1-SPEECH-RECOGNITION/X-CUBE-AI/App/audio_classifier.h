...
#define AI_AUDIO_CLASSIFIER_ORIGIN_MODEL_NAME   "model_no_quant"
...
#define AI_AUDIO_CLASSIFIER_IN_1_HEIGHT      (122)
#define AI_AUDIO_CLASSIFIER_IN_1_WIDTH       (40)
#define AI_AUDIO_CLASSIFIER_IN_1_CHANNEL     (1)
#define AI_AUDIO_CLASSIFIER_IN_1_SIZE        (122 * 40 * 1)
#define AI_AUDIO_CLASSIFIER_IN_1_SIZE_BYTES  (19520)
...
#define AI_AUDIO_CLASSIFIER_OUT_1_CHANNEL     (3)
#define AI_AUDIO_CLASSIFIER_OUT_1_SIZE        (3)
#define AI_AUDIO_CLASSIFIER_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_AUDIO_CLASSIFIER_N_NODES (8)
